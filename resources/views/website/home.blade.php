...
<div class="site-hero w-full relative">
    ...
    <div class="btn-appointment mx-0  mt-3  absolute xxsm:relative xsm:relative sm:absolute">
        <h1 class="font-fira-sans text-white font-normal text-6xl !1xl:w-2/4 2xl:w-1/3 md:w-3/4 xxsm:w-full leading-snug mb-10">Skip Travelling Online <span style="color:#5fb577">Consultation</span> is the Future</h1>
