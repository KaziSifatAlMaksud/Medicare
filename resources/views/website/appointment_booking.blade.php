                ...
                <div id="step2" class="hidden">
                    <div class="flex xxsm:flex-col sm:flex-row">
                        <div class="2xl:w-1/2 border-r xxsm:w-full">
                            ...
                            @endif
                            <div class="p-5">
                                <label for="visit_req" class="text-base font-normal font-fira-sans pb-2">{{__('Select Option for Online or Clinic Visit?')}}</label>
                                <select id="visit_req" aria-placeholder="visit_req" name="visit_req" class="border border-white-light text-gray text-sm bg-white-50 focus:ring-primary focus:border-primary block w-full p-1.5 mt-2">
                                    <option value="0" selected>{{ __('Online Visit') }}</option>
                                    <option value="1">{{__('Clinick Vist')}}</option>
                                </select>
                            </div>
                            <div class="p-5">
