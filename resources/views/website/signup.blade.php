                ...
                <div class="{{ $active == 'doctor' ?  'active' : 'hide' }} doctorDiv">
                    ...
                    <div class="input-group flex items-center">
                        <input id="password" type="password"
                            ...
                            placeholder="{{__('Enter password')}}" name="doc_password" required style="flex: 1;">
                           <button class="btn btn-outline-secondary border p-2 rounded ml-1" style="border: solid 1px gray;" type="button" id="togglePassword">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="input-group flex items-center">
                                <input id="password1" type="password"
                                    class="@error('password') is-invalid @enderror w-full text-sm font-fira-sans text-gray p-2 border border-white-light"
                                    placeholder="{{__('Enter password')}}" name="password" required style="flex: 1;">
                                <button class="btn btn-outline-secondary border p-2 rounded ml-1" style="border: solid 1px gray;" type="button" id="togglePassword1">
